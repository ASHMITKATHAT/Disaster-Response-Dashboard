...
class Config:
    ...
    OPENWEATHER_API_KEY = os.getenv('OPENWEATHER_API_KEY', 'b739a2caf5ee76a203d34a897e4966bf')
    ISRO_LULC_API_KEY = os.getenv('ISRO_LULC_API_KEY', '8bbd8dc843f3cf58947747abde84e21ccdcae38c')
    NASA_API_KEY = os.getenv('NASA_API_KEY', 'QcbYiaBuygHvkbOjTmCYBQgmIa8ZABv2kyOSabDB')
